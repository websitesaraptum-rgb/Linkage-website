...
import linkageClientImg from "../assets/linkage-client.jpg";
const Clients = () => {
  const backgroundImageURL = linkageClientImg;
  const clientCategories = [
    {
      ...
      clients: [
        ...
        },
        {
          ...
          description: "Community-focused financial institution",
        },
        { name: "EADB Bank", description: "East African Development Bank" },
        {
          name: "Post Office Savings Bank",
          description: "Government savings institution",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      clients: [
        {
          name: "Britam",
          description: "Leading insurance and financial services group",
        },
      ],
    },
    {
      ...
      clients: [
        ...
        {
          name: "Uganda Gatsby Trust",
          description: "Skills development organization",
        },
      ],
    },
    {
  ...
  const testimonials = [
    {
      quote:
        "ConsultPro transformed our organizational structure and helped us achieve remarkable efficiency gains. Their expertise in payroll management and staff training has been invaluable.",
      client: "First Community Bank",
      position: "HR Director",
    },
    {
      quote:
        "The multi-country job evaluation project was executed flawlessly. ConsultPro's regional expertise and systematic approach delivered results beyond our expectations.",
      client: "Unilever ESA",
      position: "Regional HR Manager",
    },
    {
      quote:
        "Their performance management system implementation has revolutionized how we track and improve employee performance. The results speak for themselves.",
              ...
              <div key={index}>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  {category.clients.map((client, clientIndex) => (
                    <div
                      key={clientIndex}
                      className="bg-card p-6 rounded-lg card-shadow hover:shadow-hover transition-smooth"
                    >
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground">
                Measurable outcomes and tangible business impact
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground">
                Deep understanding of East African business environment
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground">
                Flexible and responsive project execution
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground">
                Committed to your sustained success
              </p>
            </div>
          </div>
        </div>
