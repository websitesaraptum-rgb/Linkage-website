        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-muted-foreground">Proven track record of successful project delivery</p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12 max-w-4xl mx-auto">
            <div className="bg-card p-6 rounded-lg card-shadow">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <span>Comprehensive needs assessment and strategy development</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-secondary rounded-full mt-2"></div>
                ...
                <li className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-secondary rounded-full mt-2"></div>
                  <span>Continuous monitoring and optimization for sustained results</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-card p-6 rounded-lg card-shadow">
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-secondary rounded-full mt-2"></div>
                  <span>ISO-certified processes and quality management systems</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-secondary rounded-full mt-2"></div>
                  <span>Regular performance reviews and improvement initiatives</span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-secondary rounded-full mt-2"></div>
